"""
Tiny ImageNet experiment with ResNet-18 and layer-wise federated learning.
"""
import os
import sys
import json
...
from config.tinyimagenet_config import config
...
def main():
    ...
    print("="*70)
    print("Tiny ImageNet Experiment - Layer-wise Federated Learning")
    print("="*70)
    ...
    output_file = os.path.join(
        config['results_dir'],
        f"tinyimagenet_resnet18_{config['clustering_method']}.json"
    )
